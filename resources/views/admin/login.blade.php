...
<html
    ...
    data-assets-path="../adminassets/assets/"
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../adminassets/assets/img/favicon/favicon.ico" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="/adminassets/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <form action="{{route('loginadmincheck')}}" class="mb-3"  method="post">
                        @csrf
                        <div class="mb-3">
                            <label for="email" name="email" class="form-label">Email or Username</label>
                            <input
                                type="text"
                                class="form-control"
                                id="email"
